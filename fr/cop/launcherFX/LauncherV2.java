...
public class LauncherV2 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Scene newsScene = new Scene(root, 1280.0, 544.0);
		...
		AnchorPane.setLeftAnchor(center, 512.0 - 110);
		AnchorPane.setLeftAnchor(details, 512.0);

		AnchorPane.setTopAnchor(b0, 92.0);
		AnchorPane.setTopAnchor(b1, 72 * 2.0 + 20);
		AnchorPane.setTopAnchor(b2, 72 * 3.0 + 20);
		AnchorPane.setTopAnchor(b3, 72 * 3.0 + 56);
		AnchorPane.setTopAnchor(b4, 72 * 3.0 + 56);
		AnchorPane.setTopAnchor(center, 175.0);
